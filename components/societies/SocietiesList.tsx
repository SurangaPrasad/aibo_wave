        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden">
            <div className="grid md:grid-cols-2 gap-0">
              <div className="p-8 md:p-12 flex flex-col">
                ...
                <p className="text-xl font-semibold text-accent mb-6">We See You</p>
                ...
                <div className="mt-auto">
                  <Link href="/silent-echo">
                    <Button className="bg-accent hover:bg-accent/90 flex items-center gap-2" size="lg">
              ...
              <div className="p-8 md:p-12 border-l border-border">
                ...
                <div className="space-y-4 mb-8">
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <p className="text-xs font-semibold text-accent uppercase tracking-wide mb-1">Event Name</p>
                    <p className="font-medium">The Society at Silent Echo: Oulu</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-card rounded-lg p-4 border border-border">
                      <p className="text-xs font-semibold text-accent uppercase tracking-wide mb-1">Date</p>
                      <p className="font-medium text-sm">Friday, Jan 2, 2026</p>
                    </div>
                    <div className="bg-card rounded-lg p-4 border border-border">
                      <p className="text-xs font-semibold text-accent uppercase tracking-wide mb-1">Time</p>
                      <p className="font-medium text-sm">6:00 PM - 8:00 PM</p>
                    </div>
                  </div>
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <p className="text-xs font-semibold text-accent uppercase tracking-wide mb-1">Location</p>
                    <p className="font-medium">Oulu Cultural Centre</p>
                  </div>
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <p className="text-xs font-semibold text-accent uppercase tracking-wide mb-1">Community</p>
                    <p className="font-medium">Sri Lankan Diaspora</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-card rounded-lg p-4 border border-border">
                      <p className="text-xs font-semibold text-accent uppercase tracking-wide mb-1">Capacity</p>
                      <p className="font-medium text-sm">30-50 people</p>
                    </div>
                    <div className="bg-card rounded-lg p-4 border border-border">
                      <p className="text-xs font-semibold text-accent uppercase tracking-wide mb-1">Cost</p>
                      <p className="font-medium text-sm">Free</p>
                    </div>
                  </div>
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <p className="text-xs font-semibold text-accent uppercase tracking-wide mb-1">Beacon Guest</p>
                  ...
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <p className="text-xs font-semibold text-accent uppercase tracking-wide mb-1">Hosts</p>
                    <p className="font-medium text-sm">Thilina Weththasinghe & Vidura Dias</p>
                  </div>
                </div>
                
                <Link href="/silent-echo">
                  <Button className="w-full bg-accent hover:bg-accent/90 shadow-sm" size="lg">
          ...
          <div className="border border-border border-dashed rounded-xl p-8 md:p-12 text-center">
            ...
            <p className="text-muted-foreground">
              Interested in hosting a Society in your community? <Link href="/apply" className="text-accent hover:underline font-semibold">Become a Beacon</Link>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-20 md:py-32">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
            <h3 className="text-2xl font-bold mb-4 text-accent">Member Benefits</h3>
          ...
          <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
            <h3 className="text-2xl font-bold mb-4 text-accent">Beaconship (Leaders)</h3>
